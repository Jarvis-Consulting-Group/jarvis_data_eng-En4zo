...
//        HttpResponse response = httpHelper.httpPost(TwitterHttpHelper.uri, text);
        HttpResponse response = httpHelper.httpGet(URI.create("https://api.twitter.com/2/tweets?ids=1631058476355993605&tweet.fields=id,created_at,text,entities,public_metrics,geo&expansions=geo.place_id&place.fields=geo"));
